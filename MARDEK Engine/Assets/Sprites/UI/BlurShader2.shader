// From https://forum.unity.com/threads/solved-dynamic-blurred-background-on-ui.345083/#post-3747865
// Less performant than BlurMaterial's BlurShader.shader, but actually works on UI Canvas Images unlike the other one

Shader "CustomRenderTexture/BlurShader2"
{
    ...
    Category
    {
        ...
        SubShader
        {
            ...
            CGPROGRAM
                ...
                #include "BlurShader2_UIBlur_Shared.cginc"
